...
const Withdrawal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedGoal && amount > selectedGoal.currentBalance) {
      alert(`Insufficient balance: You can only withdraw ${selectedGoal.currentBalance} in the selected goal.`);
      return;
    }
    try {
  ...
  return (
    <div style={containerStyle}>
      <h2 style={{ textAlign: 'center' }}>Request Withdrawal</h2>
